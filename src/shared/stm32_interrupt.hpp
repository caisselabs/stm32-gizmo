...
/**
 *  TODO : this needs to move to the applications
...
inline void setup_interrupts() {
    ...
    auto NVIC_ISER0 = (std::uint32_t volatile *const)(0xe000'e100);
    auto NVIC_ISER1 = (std::uint32_t volatile *const)(0xe000'e104);
    // interrupt clear-enable register
    auto NVIC_ICER0 = (std::uint32_t volatile *const)(0xe000'e180);
    auto NVIC_ICER1 = (std::uint32_t volatile *const)(0xe000'e184);

    // enable TIM2 interrupt for the timer
    // TIM2_Handler
    // interrupt 26 bit
    constexpr std::uint32_t INT28_BIT = 0x1000'0000;
    constexpr std::uint32_t INT31_BIT = 0x8000'0000;
    *NVIC_ISER0 = (INT28_BIT | INT31_BIT);
